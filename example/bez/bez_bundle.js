...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_bezier_accelerator__ = __webpack_require__(1);
...
{	
    ...
    dF = 3.5;
    tF = 4;
    let dObj = new __WEBPACK_IMPORTED_MODULE_0__src_bezier_accelerator__["a" /* default */](v0, vF, tF, dF); 
...
function doVersion3()
{
    ...
    dF = 400;
    tF = 2;
    main(new __WEBPACK_IMPORTED_MODULE_0__src_bezier_accelerator__["a" /* default */](v0, vF, tF, dF));
}
function doVersion4()
{
    version = '3';

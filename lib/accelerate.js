...
var BezDecelerator = exports.BezDecelerator = function Decelerator(v0, vF, tF, dF, cb) {
   ...
   if (v0 == 0) {
      ...
      var _P2 = [T / 3.0, 0];
      var _P3 = [T, D];
      var _P4 = [2.0 / 3.0 * T, D - vF * T / 3.0];
      func = (0, _bez_functions.CubicBezier)(_P, _P2, _P4, _P3);
   }
   // Terminal velocity is zero - fit with quadratic
         ...
         var _P6 = [T, D];
         var _P7 = [D / V, D];
         func = (0, _bez_functions.QuadraticBezier)(_P5, _P7, _P6);
      }
      ...
      // hence can fit with a quadratic bezier
            ...
            var p1_y = v0 * p1_x;
            func = (0, _bez_functions.QuadraticBezier)(_P8, [p1_x, p1_y], _P9);
         }
         ...
         // needs a cubic bezier to fit
               ...
               var _P10 = [0.0, 0.0];
               if (true) {
                  var _P11 = [T / 3.0, V * T / 3.0];
                  var _P12 = [T, D];
                  var _P13 = [2.0 / 3.0 * T, D - vF * T / 3.0];
                  func = (0, _bez_functions.CubicBezier)(_P10, _P11, _P13, _P12);
               } else {
                  // this does not work
                  var _P14 = [D / V, D];
                  var _P15 = [T, D];
                  ...
                  var P1_adj = [_P14[0] * alpha, _P14[1] * alpha];

                  // attempts to add a stretch factor .. seems to work for alpha 0.0 .. 1.0
                  var P2_adj = [T - D * alpha / vF, D * (1.0 - alpha)]; // alpha 0 .. 1

                  func = (0, _bez_functions.CubicBezier)(_P10, P1_adj, P2_adj, _P15);
               }
            }
            ...
            // THIS SHOULD BE OBSOLETE
                  ...
                  // let P1 = [D/V, D];
                  if (true) {
                     var _P18 = [T / 3.0, V * T / 3.0];
                     var _P19 = [T, D];
                     var _P20 = [2.0 / 3.0 * T, D - vF * T / 3.0];
                     func = (0, _bez_functions.CubicBezier)(_P17, _P18, _P20, _P19);
                  } else {
                     // this does not work
                     var _p2_x = T - D / vF;
                     var _p2_y = 0.0;
                     var _P21 = [_p2_x, _p2_y];
                     var _alpha = .75;

                     var _P1_adj = [P1[0] * _alpha, P1[1] * _alpha];

                     // attempts to add a stretch factor .. seems to work for alpha 0.0 .. 1.0
                     var _P2_adj = [T - D * _alpha / vF, D * (1.0 - _alpha)]; // alpha 0 .. 1

                     func = (0, _bez_functions.CubicBezier)(_P17, _P1_adj, _P2_adj, P3);
                  }
               }

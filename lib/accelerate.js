...
var BezierAccelerator = function () {
    function BezierAccelerator(v0, vF, tF, dF, cb) {
        ...
        if (v0 > 0 && vF == 0 && T * v0 > D) {
            ...
            this.func = (0, _bezierFunctions.QuadraticBezier)(P0, [p1_x, p1_y], P2);
        } else {
            P0 = [0.0, 0.0];
            P1 = [T / 3.0, V * T / 3.0];
    ...
    _createClass(BezierAccelerator, [{
        key: 'tangent_initial',
        value: function tangent_initial(t) {
            return this.V * t;
        }
    }, {
        key: 'dotPositions',
        ...
        key: 'tangent_final',
        value: function tangent_final(t) {
        ...
        value: function getPositionAfter(elapsed_time) {
        ...
        */
        ...
        key: 'getDistance',
        value: function getDistance(x_value) {
            if (this.complete) {
    ...
    _createClass(Accelerate, [{
        ...
        value: function advanceTimeBy(deltaTime) {
            if (!this.changingVelocity) {
                ...
                var tmp = this.bezAccelerator.getDistance(this.elapsedTimeChangingVelocity);
        ...
        key: 'accelerate',
        value: function accelerate(vF, tF, dF, delay) {
            var _this = this;
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (_this.changingVelocity && !_this.allowOverwrite) {
                    reject('cannot have two accelerations underway at the same time');

                    return;
                }

                _this.kill(); // overwrite an existing animation

                _this.resolvePromise = resolve;

                var v0 = _this.currentVelocity;

                _this.distanceBeforeVelocityChange = _this.totalDistance;
                _this.changingVelocity = true;
                _this.elapsedTimeChangingVelocity = 0.0;
                _this.timeForChange = tF;
                _this.newVelocity = vF;
                _this.distanceForChange = dF;

                _this.bezAccelerator = new _bezierAccelerator2.default(v0, vF, tF, dF, function () {
                    _this.currentVelocity = _this.newVelocity;
                    _this.kill();
                });
            });
        }
